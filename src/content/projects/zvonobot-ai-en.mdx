...
description: "Multi-tenant SaaS console for outbound voice AI agents. Launched the line in the fall of 2025 inside Prof-IT and run it end-to-end: product, UX, engineering. It's live, so you can open it and register."
role: "Product lead, product engineer"
timeline: "Hypothesis test in fall 2025, in-house platform from 2026, actively shipping"
impact: "500,000+ minutes of live conversations in production"
...
Zvonobot AI is a new product I launched inside the Prof-IT group and run end-to-end: product, UX, and engineering. The line started in the fall of 2025 as a hypothesis test on a white-label platform; once live customers proved the demand, we moved to an in-house solution. It is a multi-tenant SaaS console on top of telephony infrastructure: clients assemble voice AI agents, give them a prompt and a base of contacts, and run outbound campaigns like sales, onboarding, reactivation, and surveys.

The product has already handled **500,000+ minutes of live conversations in production**.
