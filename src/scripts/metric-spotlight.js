...
// astro:page-load fires on the initial load as well as after every swap, so it
// is the whole bootstrap. The immediate call this file used to carry alongside
// it ran init twice per cold load; harmless here thanks to the per-element
// dataset guard, but the repo settled on one pattern.
